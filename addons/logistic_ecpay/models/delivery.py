...
class LogisticEcpay(models.Model):
    ...
    def create_test_data(self):
        ...
        action_url = self.get_ecpay_urls(self.prod_environment)[
            'CREATE_TEST_DATA']
        # 建立物流訂單並接收回應訊息
        ...
        reply_result.pop('ReceiverEmail')
        reply_result.pop('ReceiverPhone')
        shipping_ecpay_model = self.env['shipping.ecpay.model'].create(
            reply_result)
        return {
